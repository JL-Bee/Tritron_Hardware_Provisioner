...
class _ConsoleWidgetState extends State<ConsoleWidget> {
  ...
  static const List<String> _autocompleteCommands = [
    ...
    'mesh/device/sub/get',
    'mesh/dali_lc/idle_cfg/set',
    'mesh/dali_lc/idle_cfg/get',
    'mesh/dali_lc/trigger_cfg/set',
    'mesh/dali_lc/trigger_cfg/get',
    'mesh/dali_lc/identify/set',
    'mesh/dali_lc/identify/get',
    'mesh/dali_lc/override/set',
    'mesh/dali_lc/override/get',
    'mesh/radar/cfg/set',
    'mesh/radar/cfg/get',
    'mesh/radar/enable/set',
    'mesh/radar/enable/get',
  ];
